<template>
  <div class="login">
    ...
    <div v-if="showUpdateRequired" class="register">
      Your data is older than 3 months and needs to be updated. <br><br>
      Please update your information via one of these links:<br><br>
      <div class="update-buttons">
        <a :href="croatianUpdateLink" class="update-button" target="_blank" rel="noopener noreferrer">Croatian</a>
        <a :href="englishUpdateLink" class="update-button" target="_blank" rel="noopener noreferrer">English</a>
      </div>
    </div>
  </div>
</template>
